# -*- coding: utf-8 -*-
"""
Created on Fri Jun 10 10:38:13 2016
## 处理 order,weather,traffic的信息，生成三个csv文件，包括21天的订单、天气、交通信息
##
...
df.to_csv('trainingData_order.csv',index=False)
...
df = df[namesWeather]
df.to_csv('trainingData_weather.csv',index=False)
...
df = df[namesTraffic]
df.to_csv('trainingData_traffic.csv',index=False)  
